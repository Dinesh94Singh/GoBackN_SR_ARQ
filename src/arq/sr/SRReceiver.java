...
public class SRReceiver extends ARQSocket implements Runnable {
	ServerSocket ss;
					...
					while (s.isConnected()) {
						...
						if ("stopServer".equalsIgnoreCase(signal)) {
							...
							if (packIndex == 0
								...
								dataContent[packIndex]=dataPacket;
								writeln("ack:"+(packIndex*-1));
								System.out.println("...Accepted And NACKed!");			
							}
						}
					}
	...
	public static void main(String ...a) throws Exception {
		SRReceiver srr = new SRReceiver();
		srr.ss = new ServerSocket(1234);
		srr.tServer.start();
